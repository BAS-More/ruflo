...
export default function AnimateHeight() {
  ...
  return (
    <div className="wrapper">
      <button onClick={() => setShowExtraContent((b) => !b)}>Toggle height</button>
      ...
      >
        ...
        <div className="inner" ref={ref}>
          ...
          <p>
            This content can grow and shrink. The animation smoothly transitions between heights.
          </p>
          {showExtraContent && (
            <p>
              This extra content will change the height of the drawer. The animation handles any
